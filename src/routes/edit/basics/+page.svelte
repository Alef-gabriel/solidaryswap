...
<div class="w-full">
  ...
  <div class="flex gap-16 w-full h-86 items-center justify-center p-8">
    <div class="w-1/4">
      ...
      <br />
      <p class="text-gray-400 text-sm">
        Potential backers will also see them if your project appears on category
        pages, search results, or in emails we send to our community.
      </p>
    </div>
  ...
  <div class="flex gap-16 w-full h-86 items-center justify-center p-8">
    <div class="w-1/4">
      ...
      <br />
      <p class="text-gray-400 text-sm">
        Your second subcategory will help us provide more relevant guidance for
        your project. It won’t display on your project page or affect how it
  ...
  <div class="flex gap-16 w-full h-86 items-center justify-center p-8">
    <div class="w-1/4">
      ...
      <p class="text-gray-400 text-sm">
        Add an image that clearly represents your project. Choose one that looks
        good at different sizes—it’ll appear on your project page, across the
        Kickstarter website and mobile apps, and (when shared) on social
        channels.
      </p>
      <br />
      <p class="text-gray-400 text-sm">
      ...
      <br />
      <p class="text-gray-400 text-sm">
        Avoid images with banners, badges, or text—they are illegible at smaller
        sizes, can be penalized by the Facebook algorithm, and decrease your
        chances of getting Kickstarter homepage and newsletter features.
      </p>
    </div>
    <div class="flex flex-col gap-8 w-3/4">
...
<div class="flex gap-16 w-full h-86 items-center justify-center p-8">
  <div class="w-1/4">
    ...
    <br />
    <p class="text-gray-400 text-sm">
      Funding is all-or-nothing. If you don’t meet your goal, you won’t receive
      any money.
    </p>
  </div>
  <div class="flex flex-col gap-8 w-3/4">
